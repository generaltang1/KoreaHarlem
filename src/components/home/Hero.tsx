  ...
  return (
    <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden md:min-h-[85vh]">
      ...
      <div className="relative z-10 px-6 text-center text-white">
        <p className="mb-6 text-[10px] uppercase tracking-[0.4em] text-white/60">
          종합 예술 플랫폼
        </p>
        <h1 className="text-4xl font-light uppercase tracking-[0.15em] md:text-6xl lg:text-7xl">
          KoreaHarlem
        </h1>
        ...
        <Link
          href="/works"
          className="mt-10 inline-block border border-white/40 px-8 py-3 text-xs uppercase tracking-widest transition-all hover:bg-white hover:text-black"
        >
          Explore Now →
        </Link>
      </div>
